...
MODEL_URI = os.getenv("MODEL_URI")  # explicit mlflow model uri e.g., models:/name/Stage or runs:/<run_id>/artifacts/model
...
def load_predictor() -> None:
    ...
    # if looks like mlflow model URI, use mlflow to download the artifact directory
